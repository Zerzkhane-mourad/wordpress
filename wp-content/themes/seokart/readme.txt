...
-------------------------------------------------------------------------------------------------
License and Copyrights for Resources used in SeoKart WordPress Theme
-------------------------------------------------------------------------------------------------
...
=================================================================================================
Screenshot Image
URL: https://pxhere.com/en/photo/1622682
...
@version 1.0.6
* Checked Compatibility by WordPress 5.9

@version 1.0.5
* Checked Compatibility by WordPress 5.8.2

@version 1.0.4
* Theme Description Updated

@version 1.0.3
* Blockquote  Color Issue Fixed
